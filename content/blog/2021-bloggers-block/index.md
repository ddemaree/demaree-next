...
subtitle: Thoughts on blogging, or trying to blog, in 2021
description: Thoughts on blogging, or trying to blog, in 2021
date: 2021-02-27
tags: ["Writing"]
...
This style of writing can be easy to overthink — and I definitely do overthink it — in part because the lines can get really blurry between pointing at things enthusiastically and pointing at them for judgment, and also because a lot of blogging long ago shifted from individual people sharing things they love to something more like traditional media.

----

As much as I'd love to say Kottke is my biggest influence as a blogger, if I'm honest over the years I've taken much more inspiration from [John Gruber](http://daringfireball.net), [M.G. Siegler](https://mgs.blog), and tech blogs-turned-media outlets like TechCrunch and The Verge, writers whose stock-in-trade is having Opinions™ about the Tech Industry® which are taken Very Seriously by many, many people.

I think Gruber definitely still qualifies as a blogger, but he and Daring Fireball embody a variation on the form: pointing at things not just to say "whoa," but often pointing at them to say "what the fuck?!", and sometimes saying (in Nelson Muntz's voice) "ha ha!" And over the years these other styles of posting have become most of our online discourse, leading us to some pretty dark places.

As an introvert who spent almost three decades really unsure of his place in the world, I found something really appealing about writing that doesn't just seem right, but which _glorifies_ in being right and on the winning team. I've devoted the lion's share of my attention to tech since I was a teenager, dating back to before software ate the world, when making 'tech' one's identity seemed nerdier, smaller, and far less gross.
...
[Boing Boing](https://boingboing.net) used to be a great example of a site that pointed at things and said "whoa" — its original tagline was, in fact, "A DIRECTORY OF WONDERFUL THINGS," and it consisted mostly of interesting links with just a few sentences — or even just a few words — of context and commentary. This is what their homepage looked like in 2001:

{{< cloudinary-img src="demaree-dot-me/2021/bloggers-block/screenshot-boingboing-2001" >}}
<a href="https://web.archive.org/web/20010308172358/http://www.boingboing.net/">The <i>Boing Boing</i> home page on March 7, 2001</a>, via the Wayback Machine
{{< /cloudinary-img >}}

Today's Boing Boing is, sadly, quite different. The site became a more conventional media property years ago, and today's homepage is hard to distinguish from any other ad- and tracker-laden media website — not just aesthetically, with its total nothingburger design, but also in the content. The directory of wonderful things reads like all the other tech blogs, but with a worse reading experience.

{{< cloudinary-img src="demaree-dot-me/2021/bloggers-block/screenshot-boingboing-2021" />}}

Monetization, or the passive expectation that writers need to monetize, has made it hard to find good models for amateur blogging on today's web. If you search for queries like _what to write for a blog_ a lot of the advice will be geared not to what will produce good writing, but what will SEO well and drive lead-generation or ad click-through rates.
...
Now that I'm older, I've gotten more and more bored with tech advocacy, while feeling like I don't have much to say about anything else. And even though the world is full of things that make me want to go _what the fuck_, I want my blogging hobby to be a _break_ from all of that.

I want to point at things and fall in love.
...
Some things I've observed about myself along the way:

## Images and embeds are very important

## The ability to make custom shortcodes is like candy
