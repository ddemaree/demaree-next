...
function HomePage({ wpPosts, shortBio, latestSubstack }) {
  ...
  const Headline = ({ children }) => <h2 className="uppercase font-mono font-semibold tracking-wider text-center text-lg text-accent mb-4">{ children }</h2>

  return <Layout hideFooterSocials={true} activeNav="home">
    <Section className="grid dd-grid-cols dd-homepage-unit">
