...
function HomePage({ posts, latestSubstack }) {
  ...
  return <Layout hideFooterSocials={true} activeNav="home" wrapperClassName="dd-surface-green-900 dd-inkMedium-green-300 dd-ink-green-100 dd-accent-red-400 dd-inkBold-white dd-inkLight-green-600">
